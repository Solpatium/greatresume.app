...
export const Modal: React.FC<{ title: string; children: React.ReactNode; onClose: () => void }> = ({
  ...
  <Transition.Root show={true} as={Fragment}>
    <Dialog as="div" className="fixed z-10 inset-0 overflow-y-auto" onClose={onClose}>
      <div className="flex items-end justify-center min-h-screen min-h-[100dvh] pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        <Transition.Child
          as={Fragment}
        ...
        <span className="hidden sm:inline-block sm:align-middle sm:h-screen sm:h-[100dvh]" aria-hidden="true">
          &#8203;
        </span>
        ...
        <Transition.Child
          ...
          <Dialog.Panel className="relative inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-2xl sm:w-full sm:p-6">
            <div className="flex  mb-4 flex-row space-between gap-2 align-center">
              <Dialog.Title as="h3" className="flex-grow text-lg leading-6 font-semibold text-gray-900">
                {title}
              </Dialog.Title>
              <button
                type="button"
